  	...
  	$(document).ready(function(){
  		$("#id").on("keyup", function(){
  			/*
  			 ...
  			 data => Ajax로 요청을 실행하기 위해 외부에서 입력 받아야 하는 값이 있는 경우 전달
  			 		 json형식으로 만들어서 보낸다.
  			 ...
  			 jQuery에서 Ajax로 요청하기 - post방식: $.get방식과 동일한 형식
  			 $.post(url, data, success, dataType)
  			 */
  			
  			 $.get("/erp/emp/idcheck.do", {"id":$("#id").val()},
  			...
  			//location.href="/erp/emp/idCheck.do?id="+$("#id").val(); => 원하는 작업을 할 수 없다
  		})	
  	});
  </script>
</head>
